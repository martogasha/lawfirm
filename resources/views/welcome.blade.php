...
<!-- Mirrored from www.designesia.com/themes/justica/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 05 Nov 2021 12:47:16 GMT -->
<head>
    <meta charset="utf-8" />
    <title>Home - Waweru Nyambura & CO. ADVOCATE</title>
                    ...
                    <div class="de-flex sm-pt10">
                        ...
                        <div class="de-flex-col header-col-mid">
                            ...
                            <ul id="mainmenu">
                                ...
                                <li><a href="{{url('practiceArea')}}">Practice Areas</a>
                                </li>
                                <li><a href="#">Blog</a>
                                </li>
                        ...
                        <div class="de-flex-col">
                            <div class="h-phone md-hide"><span>Need&nbsp;Help?</span><i class="fa fa-phone"></i> 0721 611 374 / 0746463548</div>
            ...
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-4 text-lg-right rtl-lg-left text-sm-center">
                        <a href="{{url('contact')}}" class="btn-custom btn-black light">Make Appointment</a>
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="widget">
                        ...
                        <form action="https://www.designesia.com/themes/justica/blank.php" class="row" id="form_subscribe" method="post" name="form_subscribe">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="de-flex">
                            <div class="de-flex-col">
                                &copy; Copyright 2022 - WAWERU NYAMBURA & CO. ADVOCATE
                            </div>
                        </div>
                    </div>
                </div>
...
<!-- Mirrored from www.designesia.com/themes/justica/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 05 Nov 2021 12:49:47 GMT -->
</html>
